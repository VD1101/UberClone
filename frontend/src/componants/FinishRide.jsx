...
const FinishRide = ({ setFinishRidePanel, ride }) => {
    ...
    return (
        <div className='w-screen flex flex-col justify-center items-center'>
            <h1 onClick={() => { setFinishRidePanel(false) }}><i className="ri-arrow-down-wide-fill text-2xl font-bold"></i></h1>
            <h1 className='text-2xl  pt-2 pl-2 font-medium inline-block text-center'>Finish Ride!</h1>
            ...
            <div className='w-full border-t-[1px] border-[#efeaea] flex flex-col object-fill'>
                ...
                <button onClick={() => {endRide()}} className='bg-[#000000]  absolute bottom-4 left-2  inline-block tracking-widest w-[95%] text-white text-center py-3 text-xl   rounded-lg'>Finish Ride</button>
            </div>
        </div>
    )
}
